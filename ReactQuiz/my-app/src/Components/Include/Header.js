              ...
              <div className="collapse navbar-collapse " id="navbarSupportedContent">
                <ul className="navbar-nav ml-auto">
                  ...
                  <li className="nav-item">
                    <Link className="nav-link text-uppercase" to="/Aboutus">Upcomming</Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link text-uppercase" to="/Game">Games</Link>
                  </li>
                  <li className="nav-item">
                  ...
                  <li className="nav-item">
                    <Link className="btn btn-success" to="/Logout">
