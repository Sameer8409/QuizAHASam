    ...
    handleform=(event)=>{
        ...
        .then(function (response) {
            if(response.data==="already exists")
            {
                ...
                self.props.history.push('/CreateQuiz');
            }
            else{
            alert("Quiz created");
            ...
            <div id="page-wrapper">
                ...
                <div className="col-lg-12">
                            <div className="row">
                                    ...
                                    <input type="text" ref="question1" name="questioninsert"/>
                                </div>
                        </div>
                        <div className="row">
                        ...
                        <div className="col-lg-12">
                            ...
                            <input type="text" ref="question2" name="questioninsert"/>
                        </div>
                        <div className="row">
                            <div className="col-lg-3">
                                <p className="help-block">Correct answer</p>
                        ...
                        <div className="col-lg-12">
                            <div className="form-group">
                                ...
                                <input type="text" ref="question3" name="questioninsert"/>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-3">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" ref="question4" name="questioninsert"/>
                            </div>
                                <div className="row">
                                <div className="form-group">
                                    <div className="col-lg-3">
                            ...
                            <div className="form-group">
                                    ...
                                    <input type="text" ref="question5" name="questioninsert"/>
                            </div>
                            <div className="row">
                                <div className="form-group">
                                    <div className="col-lg-3">
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" ref="question6" name="questioninsert"/>
                            </div>
                            <div className="row">
                                <div className="form-group">
                                    <div className="col-lg-3">
