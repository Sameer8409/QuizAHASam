...
export default class Dashboard extends Component{
    ...
    var self = this;
        axios.post('http://sameer-intern.hestalabs.com/api/userDetails', {activePage:pageNumber})
        .then(response=>{
        ...
        if(localStorage.mydata != "admin@gmail.com")
           {
            ...
            axios.post('http://sameer-intern.hestalabs.com/api/userDetails', {activePage:1})
